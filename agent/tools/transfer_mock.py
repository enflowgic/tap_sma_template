"""
TAP Template Agent - Transfer Mock

Mock/stub for local testing without Gateway.
Simulates transfer_to_agent responses for testing agent logic.
...
TODO: Configure mock responses for your testing needs.
"""
...
def get_mock_tools():
    ...
    Use this to conditionally use mocks in your agent:

    ```python
    if os.environ.get("TAP_USE_MOCK_TRANSFER") == "true":
        from agent.tools.transfer_mock import get_mock_tools
        mock_tools = get_mock_tools()
        # Register mock tools instead of real ones
    ```
